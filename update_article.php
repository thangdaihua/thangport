            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-4">
                    ...
                    <form action="assest/update.php?type=article&id=<?= $article_id ?>&img=<?= $article["article_image"] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="arShort">Short des</label>
                            <input type="text" class="form-control" name="arShort" id="arShort" value="<?= $article["article_short"] ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="arTitle">Image</label>
                            <input type="text" class="form-control" name="arImage" id="arImage" value="<?= $article["article_image"] ?>">
                        </div>

                 
                        <div class="my-2" style="width: 200px;">
                            <img class="w-100 h-auto" src="<?= $article["article_image"] ?>" alt="">
                        </div>
