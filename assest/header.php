        ...
        <div class="d-flex flex-column flex-md-row align-items-center py-2">
            ...
            <?php if ($loggedin) : ?>
                ...
                <nav class="my-2 my-md-0 mr-md-3">
                    ...
                    <a class="p-2 px-5 text-muted" href="qnvvpzmzgkcategories.php">Category</a>
                    <a class="p-2 px-5 text-muted" href="qnvvpzmzgkadminadmin.php">Article</a>
                    <a class="p-2 px-5 text-muted" href="iyvjqamvceuishots.php">UI shot</a>
                </nav>
