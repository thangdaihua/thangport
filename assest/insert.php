        ...
        switch ($type) {
            case "article":
                ...
                $data = array(
                    ...
                    "article_short" => test_input($_POST["arShort"]),
                    "article_content" => $_POST["arContent"],
                    "article_image" => test_input($_POST["arImage"]),
            ...
            case "category":
                ...
                $data = array(
                    ...
                    "category_image" => test_input($_FILES["catImage"]),
                ...
                case "uishot":
                    ...
                    try {
                        ...
                        $sql = "INSERT INTO `uishot`(`uishot_id`, `uishot_image`, `uishot_title`, `uishot_high`) VALUES (?,?,?,?)";
    
                        $stmt = $conn->prepare($sql);
    
                        $stmt->execute([$id, $image, $title, $high]);
            ...
            case "comment":
                ...
                // Go to show.php
                header("Location: ../single_qnvvpzmzgkadminadmin.php?id=$id", true, 301);
                exit;
                break;
