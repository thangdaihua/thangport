                ...
                <table class='table table-striped table-bordered'>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $row) :
                            ...
                            <td class="text-break"><?= strip_tags(substr($row['article_short'], 0, 40)) . "..." ?></td>
                            <td><a target="_blank" href="<?= $row['article_image'] ?>"><img style="width: 300px" src="<?= $row['article_image'] ?>"></td>
